...
import { _ as Ct, a as Ie, c as Pt, d as Wt, f as Xt, h as qt, l as Qt, n as logger, o as Mt, s as Nt, u as Tt } from "./logger-TGEXLs5w.mjs";
...
import { a as writePackageJSON, r as readPackageJSON, t as findFile } from "./dist-2vKt8zLp.mjs";
import "./satisfies--kW1HehR.mjs";
import { t as getNuxtVersion } from "./versions-CItnJg_E.mjs";
import "./fs-CN5CWQ-H.mjs";
import { t as K } from "./main-DEHDvvRb.mjs";
import { i as installDependencies } from "./dist-BBwogmFB.mjs";
import { a as resolve$1, i as relative$1, n as dirname$1, t as basename$1 } from "./nypm-BEDMhqGM.mjs";
import "./jiti-CJ4dNg12.mjs";
import "./node-DrhmRM98.mjs";
import { i as $fetch, n as fetchModules, t as checkNuxtCompatibility } from "./_utils-BM9W6wzy.mjs";
import "./prepare-eIUjLvhJ.mjs";
import add_default, { t as selectModulesAutocomplete } from "./add-CpV1iArU.mjs";
...
async function downloadTemplate(input, options = {}) {
	...
	const { extract } = await import("./tar-CoFDfl7a.mjs").then((n) => n.t);
	await extract({
		file: tarPath,
		cwd: extractPath,
		onReadEntry(entry) {
	...
	if (options.install) {
		...
		const { installDependencies } = await import("./nypm-BEDMhqGM.mjs").then((n) => n.r).then((n) => n.t);
...
var init_default = defineCommand({
	...
	async run(ctx) {
		...
		if (!ctx.args.template || !ctx.args.dir) {
			const defaultTemplates = await import("./templates-BZfWrPND.mjs").then((n) => n.n).then((r) => r.templates);
