...
import { n as name, r as version, t as description } from "./package-B5J95V9o.mjs";
import { t as cwdArgs } from "./_shared-CoPxtaYg.mjs";
import { t as templates } from "./templates-BZfWrPND.mjs";
...
const commands = {
	"add": () => import("./add-CpV1iArU.mjs").then(_rDefault),
	"add-template": () => import("./add-template-lip3xTaC.mjs").then(_rDefault),
	"analyze": () => import("./analyze-DrYAqW_c.mjs").then(_rDefault),
	"build": () => import("./build-BJVzIIXr.mjs").then(_rDefault),
	"cleanup": () => import("./cleanup-CV3G4vlq.mjs").then(_rDefault),
	"_dev": () => import("./dev-child-DYNc-Kz6.mjs").then(_rDefault),
	"dev": () => import("./dev-BapV0J4-.mjs").then(_rDefault),
	"devtools": () => import("./devtools-DDh3K3nw.mjs").then(_rDefault),
	"generate": () => import("./generate-CO4rPHRv.mjs").then(_rDefault),
	"info": () => import("./info-D91kUSIk.mjs").then(_rDefault),
	"init": () => import("./init-dez0NrNm.mjs").then(_rDefault),
	"module": () => import("./module-oUvfU8xQ.mjs").then(_rDefault),
	"prepare": () => import("./prepare-eIUjLvhJ.mjs").then((n) => n.n).then(_rDefault),
	"preview": () => import("./preview-WMqpojfP.mjs").then(_rDefault),
	"start": () => import("./preview-WMqpojfP.mjs").then(_rDefault),
	"test": () => import("./test-DxGIa5RT.mjs").then(_rDefault),
	"typecheck": () => import("./typecheck-_DH1b8oo.mjs").then(_rDefault),
	"upgrade": () => import("./upgrade-C6tNKq3S.mjs").then(_rDefault)
};
...
async function checkEngines() {
	const satisfies = await import("./satisfies--kW1HehR.mjs").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)).then((r) => r.default || r);
...
const _main = defineCommand({
	...
	async setup(ctx) {
		...
		let backgroundTasks;
		if (command !== "_dev" && p$1 !== "stackblitz") backgroundTasks = Promise.all([checkEngines()]).catch((err) => logger.error(String(err)));
		...
		if (command === "add" && ctx.rawArgs[1] && templateNames.includes(ctx.rawArgs[1])) {
			...
			await runCommand(await import("./add-template-lip3xTaC.mjs").then((m) => m.default || m), [...ctx.rawArgs.slice(1)]).catch((err) => {
		...
		if (ctx.args.command && !(ctx.args.command in commands)) {
			...
			try {
				const { x } = await import("./main-DEHDvvRb.mjs").then((n) => n.n);
